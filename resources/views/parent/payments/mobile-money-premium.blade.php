    ...
    <div class="max-w-4xl mx-auto relative z-10">
        ...
        <div class="bg-gradient-to-b from-slate-800/80 via-slate-800/50 to-slate-900/80 rounded-3xl shadow-2xl overflow-hidden border border-slate-700/50 backdrop-blur-xl">
            ...
            <div class="relative overflow-hidden h-32 sm:h-40">
                ...
                <div class="relative h-full flex flex-col items-center justify-center px-4 sm:px-6 text-center">
                    <div class="flex flex-col sm:flex-row items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                        <svg class="w-7 h-7 sm:w-10 sm:h-10 text-white flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M20 8H4V6h16m0 12H4v-2h16m0-6H4c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2v-8c0-1.1-.9-2-2-2z"/>
                        </svg>
                        <h1 class="text-xl sm:text-3xl lg:text-4xl font-black text-white">{{ __('Mobile Money Payment') }}</h1>
                    </div>
                    <p class="text-blue-100 text-xs sm:text-sm font-semibold">{{ __('Fast • Secure • Transparent') }}</p>
                </div>
            </div>
            ...
            <div class="px-6 sm:px-8 py-8 border-b border-slate-700/50">
                <div class="space-y-4">
                    ...
                    <!-- Step Indicators -->
                    <div class="flex justify-between items-center mt-6 gap-1 overflow-x-auto pb-2">
                        <div class="step-indicator step-1 flex flex-col items-center group cursor-pointer flex-shrink-0">
                            <div class="relative mb-2">
                                <div class="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-cyan-500 to-blue-600 text-white text-xs leading-8 sm:leading-10 font-black text-center group-hover:scale-110 transition-transform">1</div>
                            ...
                            <span class="text-xs text-gray-400 font-medium hidden sm:block">{{ __('Details') }}</span>
                        </div>
                        <div class="flex-1 mx-1 h-1 bg-slate-700/40 rounded-full flex-shrink-0"></div>
                        
                        <div class="step-indicator step-2 flex flex-col items-center group cursor-pointer flex-shrink-0">
                            <div class="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-slate-700 text-gray-500 text-xs leading-8 sm:leading-10 font-black text-center group-hover:scale-110 transition-transform">2</div>
                            <span class="text-xs text-gray-500 font-medium hidden sm:block">{{ __('Operator') }}</span>
                        </div>
                        <div class="flex-1 mx-1 h-1 bg-slate-700/40 rounded-full flex-shrink-0"></div>

                        <div class="step-indicator step-3 flex flex-col items-center group cursor-pointer flex-shrink-0">
                            <div class="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-slate-700 text-gray-500 text-xs leading-8 sm:leading-10 font-black text-center group-hover:scale-110 transition-transform">3</div>
                            <span class="text-xs text-gray-500 font-medium hidden sm:block">{{ __('Phone') }}</span>
                        </div>
                        <div class="flex-1 mx-1 h-1 bg-slate-700/40 rounded-full flex-shrink-0"></div>

                        <div class="step-indicator step-4 flex flex-col items-center group cursor-pointer flex-shrink-0">
                            <div class="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-slate-700 text-gray-500 text-xs leading-8 sm:leading-10 font-black text-center group-hover:scale-110 transition-transform">4</div>
                            <span class="text-xs text-gray-500 font-medium hidden sm:block">{{ __('Confirm') }}</span>
                        </div>
                        <div class="flex-1 mx-1 h-1 bg-slate-700/40 rounded-full flex-shrink-0"></div>

                        <div class="step-indicator step-5 flex flex-col items-center group cursor-pointer flex-shrink-0">
                            <div class="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-slate-700 text-gray-500 text-xs leading-8 sm:leading-10 font-black text-center group-hover:scale-110 transition-transform">5</div>
                            <span class="text-xs text-gray-500 font-medium hidden sm:block">{{ __('Process') }}</span>
                        </div>
                        <div class="flex-1 mx-1 h-1 bg-slate-700/40 rounded-full flex-shrink-0"></div>

                        <div class="step-indicator step-6 flex flex-col items-center group cursor-pointer flex-shrink-0">
                            <div class="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-slate-700 text-gray-500 text-xs leading-8 sm:leading-10 font-black text-center group-hover:scale-110 transition-transform">6</div>
                            <span class="text-xs text-gray-500 font-medium hidden sm:block">{{ __('Verify') }}</span>
                        </div>
                        <div class="flex-1 mx-1 h-1 bg-slate-700/40 rounded-full flex-shrink-0"></div>

                        <div class="step-indicator step-7 flex flex-col items-center group cursor-pointer flex-shrink-0">
                            <div class="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-slate-700 text-gray-500 text-xs leading-8 sm:leading-10 font-black text-center group-hover:scale-110 transition-transform">✓</div>
                            <span class="text-xs text-gray-500 font-medium hidden sm:block">{{ __('Result') }}</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                        ...
                        <div onclick="selectOperator('orange')" class="group cursor-pointer">
                            <div id="orange-card" class="relative overflow-hidden bg-gradient-to-br from-orange-600/30 to-red-600/20 rounded-2xl p-8 border-2 border-slate-600/40 hover:border-orange-500/60 transition-all duration-300 group-hover:scale-105 transform">
                                ...
                                <div class="relative z-10 text-center">
                                    <div class="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:shadow-orange-500/50">
                        ...
                        <div onclick="selectOperator('mtn')" class="group cursor-pointer">
                            <div id="mtn-card" class="relative overflow-hidden bg-gradient-to-br from-yellow-600/30 to-amber-600/20 rounded-2xl p-8 border-2 border-slate-600/40 hover:border-yellow-500/60 transition-all duration-300 group-hover:scale-105 transform">
                                ...
                                <div class="relative z-10 text-center">
                                    <div class="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-yellow-500 to-amber-600 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:shadow-yellow-500/50">
                                        <svg class="w-10 h-10 sm:w-12 sm:h-12 text-white" fill="currentColor" viewBox="0 0 24 24">
                                            <circle cx="12" cy="12" r="10" fill="currentColor" opacity="0.1"/>
                    ...
                    <div class="flex justify-center mb-8">
                        <div class="relative w-20 h-20 sm:w-28 sm:h-28">
                            ...
                            <div class="absolute inset-0 flex items-center justify-center">
                                <svg class="w-8 h-8 sm:w-12 sm:h-12 text-blue-400" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M20 8H4V6h16m0 12H4v-2h16m0-6H4c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2v-8c0-1.1-.9-2-2-2z"/>
                                </svg>
                            </div>
                        </div>
                ...
                <div id="step-6" class="step-content hidden text-center space-y-8">
                    ...
                    <div class="flex justify-center">
                        <div class="relative w-20 h-20 sm:w-28 sm:h-28">
                            ...
                            <div class="absolute inset-0 flex items-center justify-center">
                                <svg class="w-8 h-8 sm:w-12 sm:h-12 text-blue-400 animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function startPolling() {
    ...
    pollingInterval = setInterval(async () => {
        ...
        try {
            // Using transaction_id to query payment status
            const response = await fetch('{{ route("parent.payments.statistics") }}', {
                method: 'GET',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
                }
            ...
            // In production, you'd query the actual payment status by transaction_id
            // For now, this is a placeholder that checks statistics
            // You should implement a dedicated endpoint for checking transaction status
            
            if (data && data.data) {
                // Check if payment succeeded based on your logic
                // This is simplified and should be replaced with actual check
            }
        } catch (error) {
